...
static long susfs_prctl_result(unsigned long arg5, int error)
{
...
long susfs_handle_prctl(unsigned long cmd, unsigned long arg3,
			 unsigned long arg4, unsigned long arg5)
{
	...
	return susfs_prctl_result(arg5, error);
}
